...
\begin{figure}[htbp]
    ...
    \caption{QUIC-Packet \cite{alawaji_ietf_nodate}}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{QUIC-Longheader \cite{alawaji_ietf_nodate}}
\end{figure}
\begin{itemize}
    ...
    \item \textbf{Long Packet Type (T):} Gibt den Typ des Long-Header-Pakets an, siehe Figure 5.
