\subsection{MyConnection}

Die Klasse \texttt{MyConnection} kapselt die QUIC-Client-Funktionalität. 
Sie ermöglicht den Aufbau einer Verbindung zu einem QUIC-Server, das Öffnen von Streams sowie das Senden und Empfangen von Nachrichten. 
Dabei werden bidirektionale und unidirektionale Streams unterstützt und es können mehrere parallele Streams gleichzeitig verwaltet werden.
