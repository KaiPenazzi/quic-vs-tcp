...
Die Klasse \texttt{MyQuicFactory} implementiert das Interface \texttt{ApplicationProtocolConnectionFactory} und ist für die Erzeugung neuer Verbindungen zuständig.
