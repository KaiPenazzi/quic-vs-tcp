...
\begin{itemize}
    \item Das setzen des \texttt{MyConnectionListener}, die \texttt{connected}-Methode des Listeners wird dabei allerdings nicht aufgerufen, da die Verbindung bereits vorher aufgebaut wurde.
    ...
    \item Akzeptieren von Peers initiierten Streams über \texttt{acceptPeerInitiatedStream}.
