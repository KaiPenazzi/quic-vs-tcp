...
Die Verarbeitung jedes Streams erfolgt in einem eigenen Thread, um parallele Kommunikation zu ermöglichen, was eine realistische Simulation einer Multi-Client-Umgebung erlaubt. 
