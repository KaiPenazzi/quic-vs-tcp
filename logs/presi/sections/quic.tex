...
\begin{frame}{Verbindungsaufbau}
    ...
    \centering
        \begin{minipage}{0.48\textwidth}
            \centering
            \include{sections/TCP_TLS_connection}
            \caption{TCP + TLS}
        \end{minipage}
        \hfill
        \begin{minipage}{0.48\textwidth}
            \centering
            \include{sections/quic_connection}
            \caption{QUIC}
        \end{minipage}
    \end{figure}
\end{frame}
...
\begin{frame}{Packet- und Datenzuordnung}
    ...
    \begin{itemize}
        ...
        \item Daten werden über Stream-ID und Stream-Offset identifiziert
...
\begin{frame}{User-Space Implementierung}
    \begin{itemize}
        \item QUIC wird vollständig im Userspace implementiert
