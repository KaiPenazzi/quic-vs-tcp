...
\begin{frame}{Analyse von Java-QUIC-Frameworks}
    ...
    \begin{itemize}
        ...
        \item Einsatzszenarien ableiten, für die jedes Framework besonders geeignet ist
    \end{itemize}
\end{frame}

\subsection{Kwik Client}
\begin{frame}[fragile]{Connection}
    \scriptsize
    \begin{verbatim}
...
\begin{frame}[fragile]{Stream-Management}
    \scriptsize
    \begin{verbatim}
...
\begin{frame}[fragile]{Receive-Loop}
    \scriptsize
    \begin{verbatim}
...
\begin{frame}[fragile]{QuicFactory}
    \scriptsize
    \begin{verbatim}
...
\begin{frame}[fragile]{ApplicationProtocolConnection}
    \scriptsize
    \begin{verbatim}
